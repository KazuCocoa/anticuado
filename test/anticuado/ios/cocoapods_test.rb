...
Analyzing dependencies
      ...
      def test_with_format_have_update
        cocoapod =  Anticuado::IOS::CocoaPods.new
        result = cocoapod.format OUTDATED_HAVE_UPDATE
        ...
        assert_equal OUTDATED_HAVE_UPDATE, cocoapod.outdated_libraries

        assert_equal expected_0, result[0]
        assert_equal expected_1, cocoapod.formatted_outdated_libraries[1]
        assert_nil result[2]
      end

      def test_with_format_no_update
        cocoapod =  Anticuado::IOS::CocoaPods.new
        result = cocoapod.format OUTDATED_NO_UPDATE

        expected = []

        assert_equal OUTDATED_NO_UPDATE, cocoapod.outdated_libraries
      ...
      def test_no_update_cocoapod
        ...
        cocoapod.update(pod_file_in: actual_file_path, pod_file_out: actual_output_file_path, libraries: {})
      ...
      def test_with_update_cocoapod
        ...
        cocoapod.update(pod_file_in: actual_file_path, pod_file_out: actual_output_file_path, libraries: {"AFNetworking": "4.0"})
      ...
      def test_with_update_cocoapod1
        ...
        cocoapod.update(pod_file_in: actual_file_path, pod_file_out: actual_output_file_path, libraries: {"AFNetworking": "4.0", "OHHTTPStubs": "4.2.0"})
